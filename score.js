module.exports = async function handler(req, res) {
  ...
  const RESEARCH_PROMPT = "You are a research assistant for the Civic Accountability Index. Search the web thoroughly for this official. Find campaign promises, policy actions, legislation signed, executive orders, and outcome data. Search at least 6 times with different queries. Write detailed notes with numbers, dates, quotes, and sources.";
